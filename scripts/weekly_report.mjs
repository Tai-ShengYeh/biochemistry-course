/* ============================================================
   每週學習週報：生物化學（越南學生班）（course_code: biochem-vi）
...
// 全學期資料一次撈（一學期 30 人 × 17 週 × 5 遊戲 ≈ 2500 筆，遠低於上限）
...
const lines = [];
lines.push(`# 生物化學（越南學生班）週報`);
lines.push(``);
lines.push(`- 產生時間：${tw(now)}（台北時間）`);
lines.push(`- 課程代碼：\`${COURSE}\`　資料來源：Supabase \`interactions\`（與 Firestore \`biochem_results\` 雙寫）`);
lines.push(``);
...
lines.push(`即時儀表板：https://tai-shengyeh.github.io/biochemistry-course/teacher/dashboard.html`);
